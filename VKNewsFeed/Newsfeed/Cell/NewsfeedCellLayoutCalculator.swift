...
final class FeedCellLayoutCalculator: FeedCellLayoutCalculatorProtocol {
    ...
    func sizes(postText: String?, photoAttachments: [FeedCellPhotoAttachementViewModel], isFullSizePost: Bool) -> FeedCellSizes {
        ...
        let moreTextNuttonOrigin = CGPoint(x: Constants.moreTextButtonInsets.left, y: postLabelFrame.maxY)
        
        let moreTextButtonFrame = CGRect(origin: moreTextNuttonOrigin, size: moreTextButtonSize)
